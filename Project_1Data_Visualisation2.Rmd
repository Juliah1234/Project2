---
title: 'Project 2: Present Data Visualization'
output:
  html_document:
    df_print: paged
---

Brianna Solis, Julia Higdon
Section 02
10-17-2021
...
ggplot(AmericanKennelClub.data, aes(x = `Size Category` , y = `Avg Weight (pounds)`)) + 
 ...
 loop.cols <- names(AmericanKennelClub.data)[1:3]
for (col in loop.cols) { 
  p <- vioplot(AmericanKennelClub.data$`Avg Weight (pounds)` ~ AmericanKennelClub.data$`Size Category`,
        pch = 22, 
        col=viridis(5), 
